...
short_lang=("nl" "de" "fr" "cs" "ta" "es" "it" "ta" "pt" "sv" "ta") #do not include template language ("en" usually).
long_lang=("nl" "de" "fr" "cs" "ta" "es" "it" "ta" "pt_BR" "sv" "ta") #do not include template language ("en" usually).
