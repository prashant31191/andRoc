...
public class AbsoluteLayout extends ViewGroup {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    setMeasuredDimension(resolveSize(maxWidth, widthMeasureSpec), resolveSize(
  ...
  public static class LayoutParams extends ViewGroup.LayoutParams {
     ...
     * 
     * @param width
     *          the width, either {@link #FILL_PARENT}, {@link #WRAP_CONTENT} or
     *          a fixed size in pixels
     * @param height
     *          the height, either {@link #FILL_PARENT}, {@link #WRAP_CONTENT}
