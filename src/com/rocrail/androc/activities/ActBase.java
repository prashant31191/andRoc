...
//      return true;
  ...
  public void connectView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActConnect.class);
  ...
  public void throttleView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActThrottle.class);
    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  ...
  public void systemView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActSystem.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void preferencesView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActPreferences.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void accessoryView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActAccessory.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void locosetupView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActLocoSetup.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void menuView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActMenu.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void layoutView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActLayout.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
  ...
  public void locoView() {
    Intent intent = new Intent(m_Activity,com.rocrail.androc.activities.ActLoco.class);
    m_Activity.startActivityIfNeeded(intent,0);
    if(Finish) 
      m_Activity.finish();
  }
